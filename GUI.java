...
//	public static Team FootballManager.getPc() = new Team("Not Set Yet", 0, false);
...
//	static Player a10 = new Player("Ajax10", "10", 10, 10,10, 10, 100000,true);
//	static Player a11 = new Player("Ajax11", "11", 10, 10,10, 11,100000, true);
//	
//	static ArrayList<Player> selectie = new ArrayList<Player>();
//	static ArrayList<Player> FootballManager.getWissels() = new ArrayList<Player>();
...
//    	div.add(aja);
    	...
    	if(!FootballManager.getPc().getName().equals("Not Set Yet")){
    		...
    		for(int i = 0; i < 11; i++){
    			FootballManager.getSelectie().add(new Player("Blank", "Blank", 10,10,10,(i+1),100000, true));
    		}
    	}
